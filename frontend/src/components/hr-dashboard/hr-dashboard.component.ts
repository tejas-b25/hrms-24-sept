...
@Component({
  ...
  standalone: true,
  imports: [NavbarComponent,CommonModule, NgChartsModule,RouterOutlet, HrSidebarComponent, FinanceSidebarComponent, EmployeeSidebarComponent, ManagerSidebarComponent, SidebarComponent, FormsModule, ReactiveFormsModule, ToastModule],
  templateUrl: './hr-dashboard.component.html',
  styleUrls: ['./hr-dashboard.component.css'],
  providers: [MessageService]
})
export class HrDashboardComponent implements OnInit {  username: string = '';
  empId: number = 0;
