...
@Component({
  ...
  imports: [
    CommonModule,
    EmployeeSidebarComponent,SidebarComponent,ManagerSidebarComponent,FinanceSidebarComponent,HrSidebarComponent,
    FormsModule,
    ReactiveFormsModule,
    ToastModule,
    DialogModule,
...
export class EmployeesDashboardComponent implements OnInit {
  ...
  // method for handling popup action
  submitForm(): void {
    console.log("Popup OK clicked!");
    this.showPopup = false; // close popup after click
  }
